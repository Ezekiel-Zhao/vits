...
class TextAudioLoader(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, audiopaths_and_text, hparams, mode):
        ...
        self.sampling_rate  = hparams.sampling_rate 
        self.mode = mode # pre-training, fine-tuning, or evaluation
...
class TextAudioCollate():
    ...
    """
    def __init__(self, return_ids=False, mode = 'pre-training'):
